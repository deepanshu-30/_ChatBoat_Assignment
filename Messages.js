...
import intialmess from '../../../common/constants/initialBottyMessage'
...
function Messages() {
  ...
  const[message,setmessage]=useState(intialmess)
 ...
 const sendMessage=useCallback(
   () => {
     socket.emit("USER_MESSAGE_EVENT",{message:usermess},(respond)=>{
      setstautus(true)
     })
   },
   [usermess],
